...
const fallbackArticles: NewsArticle[] = [
  {
    ...
    description:
      "Farmers gathered to protest new rules, pricing pressure, and the bureaucracy haunting their tractors.",
    url: "https://newsapi.org/",
    source: "Demo Wire",
  },
  {
    title:
      "Mexico prepares for heavy rains as officials issue public safety alerts",
    description:
      "Authorities warned communities to prepare for disruption, flooding, and the ancient ritual of checking weather apps twice.",
    url: "https://newsapi.org/",
    source: "Demo Wire",
  },
  {
    ...
    description:
      "The latest software promises to summarize meetings, draft emails, and possibly ask whether that meeting needed to exist.",
    url: "https://newsapi.org/",
    source: "Demo Wire",
  },
  {
    ...
    description:
      "Investors reacted to hints about interest rates with the emotional stability of a shopping cart on a hill.",
    url: "https://newsapi.org/",
    source: "Demo Wire",
  },
  {
    ...
    description:
      "Researchers say new materials could make batteries cheaper and cleaner, which is excellent news for everything that beeps.",
    url: "https://newsapi.org/",
    source: "Demo Wire",
  },
];
...
export function buildDailyQuiz(
  ...
  const usable = (articles.length >= 5 ? articles : fallbackArticles).slice(
    0,
    5,
  );
  ...
  return usable.map((article, index) => {
    ...
    const options = seededShuffle(
      [correctAnswer, ...otherHeadlines, decoys[index]],
      questionSeed,
    );
