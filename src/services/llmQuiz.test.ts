...
describe('generateLLMQuiz', () => {
  ...
  it('maps article metadata correctly by index', async () => {
    const articles: NewsArticle[] = [
      { title: 'A1', description: 'D1', url: 'u1', source: 'S1', imageUrl: 'img1' },
      { title: 'A2', description: 'D2', url: 'u2', source: 'S2', imageUrl: 'img2' },
    ];

    const mockQuiz = [
      { id: '0', prompt: 'P1', correctAnswer: 'C1', options: ['a', 'b', 'c', 'd'], summary: 'Sum1' },
      { id: '1', prompt: 'P2', correctAnswer: 'C2', options: ['a', 'b', 'c', 'd'], summary: 'Sum2' },
    ];
